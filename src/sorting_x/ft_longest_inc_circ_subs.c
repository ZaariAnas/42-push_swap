...
/*   Updated: 2023/04/02 16:36:36 by azari            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort_x(t_list **stack_a, t_list **stack_b)
{
	...
	if (ft_find_min_index(stack_a) <= ft_lstsize(*stack_a) / 2)
	{
		while (ft_find_min_index(stack_a))
			ra(stack_a);
	}
	if (ft_find_min_index(stack_a) > ft_lstsize(*stack_a) / 2)
	{
...
// 	}
// 	tmp = stack;
// 	while (++size < ft_find_min_index(&stack))
// 		tmp = tmp->next;
