...
#    Updated: 2022/10/21 12:09:08 by azari            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUSC = ft_lstadd_back.c ft_lstnew.c ft_lstsize.c ft_lstlast.c ft_lstadd_front.c ft_lstdelone.c ft_lstclear.c ft_lstiter.c ft_lstmap.c
OFILES = ${CFILES:.c=.o}
BONUSO = ${BONUSC:.c=.o}
